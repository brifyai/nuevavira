...
('scrapingbee_api_key', '"0PP8W5U3GBAJ5LCIOHHZ2MDDVYAG4EQK599KIO00EWIVER2I0NN5MKV37TTRM51FWUJCZC56G2ZK0XK3"', 'API key for ScrapingBee service'),
('gemini_api_key', '"AIzaSyBbhTtunEQ4VDV2L1DnQ63q0OobLVu-aEk"', 'API key for Google Gemini AI service'),
('google_tts_api_key', '"AQ.Ab8RN6JclgD9eTb7VI1-j4PJIAdGuZ0l-d_wubhqmMQnM3qYfg"', 'API key for Google Cloud Text-to-Speech'),
...
('cron_secret', '"a043d01651cec42c77433fd1f8754bdd01d43b0e56a6f451195e711b1fc95bbb"', 'Secret for cron job authentication');
